package com.example.utawalasportsclub.data
...
import com.example.utawalasportsclub.models.Product
...
class MemberViewModel(var navController: NavController, var context: Context) {
    ...
    fun uploadProduct(name:String, sport:String, description:String, phone: String,filePath: Uri){
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Product(name,sport,description,phone,imageUrl,productId)
    ...
    fun deleteProduct(productId:String){
        var ref = FirebaseDatabase.getInstance().getReference()
            .child("Products/$productId")
        ref.removeValue()
        Toast.makeText(context, "Successful well reach out to you", Toast.LENGTH_SHORT).show()
    }
}